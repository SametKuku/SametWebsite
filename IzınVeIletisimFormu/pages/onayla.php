...
if(isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    // Talebi güncelle, onaylandı olarak işaretle
    $sql = "UPDATE izin_talepleri SET status='Onaylandı' WHERE id=$request_id";

    if ($conn->query($sql) === TRUE) {
        // Onaylama işlemi başarılı olduğunda, Bootstrap modal ile onay mesajını göster
        echo '
